...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/student/student.js"></script>
...
<body>
	<div id="layout" class="easyui-layout" data-options="fit:true">
			<div data-options="region:'north',split:true,noheader:true" style="height: 60px;background-color: #666666;">
				...
				<div class="logout">
					您好，<s:property value="#session.student.studentName"/>|<a href="student_exit.action">退出</a>
				</div>
			</div>
